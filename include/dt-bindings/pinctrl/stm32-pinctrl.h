...
/* Based on Zephyr include/zephyr/dt-bindings/pinctrl/stm32-pinfunc.h*/

#define STM32_ALTFUNC_MASK 0x0f

#define STM32_DT_PIN_MODE_INPUT        0x0 0x0
#define STM32_DT_PIN_MODE_OUTPUT       0x1 0x0
#define STM32_DT_PIN_MODE_ALTFUNC(af)  0x2 af
#define STM32_DT_PIN_MODE_ANALOG       0x3 0x0
...
/* GPIO Output type */
#define STM32_OTYPER_NA             0x0
#define STM32_OTYPER_PUSH_PULL		0x0
#define STM32_OTYPER_OPEN_DRAIN		0x1

/* GPIO speed */
#define STM32_OSPEEDR_NA            0x0
#define STM32_OSPEEDR_LOW_SPEED		0x0
#define STM32_OSPEEDR_MEDIUM_SPEED	0x1
#define STM32_OSPEEDR_HIGH_SPEED	0x2
#define STM32_OSPEEDR_VERY_HIGH_SPEED 0x3

/* GPIO High impedance/Pull-up/pull-down */
#define STM32_PUPDR_NO_PULL		0x0
#define STM32_PUPDR_PULL_UP		0x1
#define STM32_PUPDR_PULL_DOWN	0x2
